...
{
    public partial class PLCLogin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lblSystemName.Text = System.Configuration.ConfigurationManager.AppSettings["PLCsystemName"] + " " + System.Configuration.ConfigurationManager.AppSettings["PLCsystemVersion"]; ;
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            finally
            {
                if (isLogin)
                {
                    ...
                    {
                        Response.Redirect("Form/PartsLocationCheckv2.aspx");
                    }
