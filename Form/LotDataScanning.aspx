<%@ Page Language="C#" MasterPageFile="~/Form/HTMasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="LotDataScanning.aspx.cs" Inherits="FGWHSEClient.Form.WebForm2" %>
    ...
    <script type="text/javascript">
        $(function () {
            $(document).keyup(function (e) {
                ...
                switch (key) {
                    case 13:
                        document.getElementById(btnDNDetails).click();
                        break;
                    case 112:
...
<br /><br />
<asp:Panel ID="Panel1" runat="server" DefaultButton="btnDNDetails">
                   ...
                   <td id="tdScan" runat="server" style="text-align:right;">
                    ...
                    <td style="padding:5px;text-align:left">
                        <asp:TextBox ID="txtDNNo" runat="server" Width="270px" Height="20px"
                         Font-Size="20px" ontextchanged="txtDNNo_TextChanged" AutoPostBack="True" 
