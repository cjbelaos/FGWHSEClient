<%@ Page Title="" Language="C#" MasterPageFile="~/Form/MasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="PSI_MASTER_VENDORS_CATEGORY.aspx.cs" Inherits="FGWHSEClient.Form.PSI_MASTER_VENDORS_CATEGORY" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--BACKUP MODAL FOR DATATABLES--%>
    <%--<div class="modal fade" id="MyModal">
        <div class="container-fluid">
            <div class="form-group">
                <label>SUPPLIER CODE</label>
                <input type="text" id="txtSupplierCode" style="width: 96%" disabled="disabled" />
            </div>
            <div class="form-group">
                <label>SUPPLIER NAME</label>
                <input type="text" id="txtSupplierName" style="width: 96%" disabled="disabled" />
            </div>
            <div class="form-group">
                <label>SUPPLIER CATEGORY</label>
                <select id="selectSupplierCategory" style="width: 100%" class="chosen">
                    <option value="LOCAL">LOCAL</option>
                    <option value="IMPORT">IMPORT</option>
                </select>
                <button type="button" id="btnFilter" class="btn btn-primary btn-sm"><i class="fa-solid fa-share-from-square"></i>&nbsp;Save</button>
            </div>
        </div>
    </div>--%>
    ...
    <script src="../Scripts/MasterVendorsCategory.js" type="text/javascript"></script>
</asp:Content>
