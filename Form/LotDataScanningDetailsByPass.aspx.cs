...
namespace FGWHSEClient.Form
{
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        void Page_PreInit(Object sender, EventArgs e)
        {
            ...
            {
                Page.Title = string.Format("MANUAL PARTS RECEIVING (DN BYPASS) - DETAILS");
            }
            else
            {
                Page.Title = string.Format("PARTS LOADING (DN BYPASS) - DETAILS");
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (strLoginType2 == "EPPI")
                {
                    lblHeader.Text = "MANUAL PARTS RECEIVING (DN BYPASS) - SCAN DETAILS";
                }
                else
                {
                    lblHeader.Text = "PARTS LOADING (DN BYPASS) - SCAN DETAILS";
                }
                        ...
                        if (!(isValidText(@"[A-Za-z0-9]", Request.QueryString["DNNo"].ToString())))
                        {
                            if (Request.QueryString["DeviceType"] != null)
                            {
                                if (Request.QueryString["DeviceType"].ToString() == "Denso")
                                {
                                    ...
                                    Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&DeviceType=Denso';");
                                    Response.Write("</script>");
                                ...
                                else if (Request.QueryString["DeviceType"].ToString() == "HT")
                                {
                                    Response.Write("<script>");
                                    Response.Write("alert('INVALID DN NOS.!');");
                                    Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&DeviceType=HT';");
                                    Response.Write("</script>");
                                    //    Response.Redirect("LotDataScanning.aspx?DNNo=" + Request.QueryString["DNNo"].ToString() + "&DeviceType=Denso");
                                }
                            }
                            else
                            {
                                ...
                                Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "';");
                                Response.Write("</script>");
                        ...
                        if (!(isValidText(@"[A-Za-z0-9]", Request.QueryString["DNNo"].ToString())))
                        {
                            if (Request.QueryString["DeviceType"] != null)
                            {
                                if (Request.QueryString["DeviceType"].ToString() == "Denso")
                                {
                                    Response.Write("<script>");
                                    Response.Write("alert('INVALID DN NO.!');");
                                    Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&DeviceType=Denso';");
                                    Response.Write("</script>");
                                    //    Response.Redirect("LotDataScanning.aspx?DNNo=" + Request.QueryString["DNNo"].ToString() + "&DeviceType=Denso");
                                }
                                else if (Request.QueryString["DeviceType"].ToString() == "HT")
                                {
                                    Response.Write("<script>");
                                    Response.Write("alert('INVALID DN NO.!');");
                                    Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&DeviceType=HT';");
                                    Response.Write("</script>");
                                    //    Response.Redirect("LotDataScanning.aspx?DNNo=" + Request.QueryString["DNNo"].ToString() + "&DeviceType=Denso");
                                }
                            }
                            else
                            {
                                Response.Write("<script>");
                                Response.Write("alert('INVALID DN NO.!');");
                                Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "';");
                                Response.Write("</script>");
                        ...
                        if (!(isValidText(@"[A-Za-z0-9]", Request.QueryString["DNNo"].ToString())))
                        {
                            if (Request.QueryString["DeviceType"] != null)
                            {
                                if (Request.QueryString["DeviceType"].ToString() == "Denso")
                                {
                                    Response.Write("<script>");
                                    Response.Write("alert('INVALID DN NO.!');");
                                    Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&QRCode=" + HttpUtility.UrlEncode(Request.QueryString["QRCode"].ToString()) + "&DeviceType=Denso';");
                                    Response.Write("</script>");
                                    //    Response.Redirect("LotDataScanning.aspx?DNNo=" + Request.QueryString["DNNo"].ToString() + "&DeviceType=Denso");
                                }
                                else if (Request.QueryString["DeviceType"].ToString() == "HT")
                                {
                                    Response.Write("<script>");
                                    Response.Write("alert('INVALID DN NO.!');");
                                    Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&QRCode=" + HttpUtility.UrlEncode(Request.QueryString["QRCode"].ToString()) + "&DeviceType=HT';");
                                    Response.Write("</script>");
                                    //    Response.Redirect("LotDataScanning.aspx?DNNo=" + Request.QueryString["DNNo"].ToString() + "&DeviceType=Denso");
                                }
                            }
                            else
                            {
                                Response.Write("<script>");
                                Response.Write("alert('INVALID DN NO.!');");
                                Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&QRCode=" + HttpUtility.UrlEncode(Request.QueryString["QRCode"].ToString()) + "';");
                                Response.Write("</script>");
                ...
                if (Request.Form["Delete"] != null)
                {
                    if (Request.Form["Delete"].ToString().Equals("1"))
                    {
                        if (Request.QueryString["DeviceType"] != null)
                        {
                            if (Request.QueryString["DeviceType"].ToString() == "Denso")
                            {
                                Response.Redirect("LotDataScanningDeleteRecordByPass.aspx?DNNo=" + txtDNNo.Text.Trim().ToUpper() + "&RFIDTag=" + txtRFID.Text.Trim().ToUpper() + "&DeviceType=Denso");
                            }
                            else if (Request.QueryString["DeviceType"].ToString() == "HT")
                            {
                                Response.Redirect("LotDataScanningDeleteRecordByPass.aspx?DNNo=" + txtDNNo.Text.Trim().ToUpper() + "&RFIDTag=" + txtRFID.Text.Trim().ToUpper() + "&DeviceType=HT");
                            }
                        }
                        else
                        {
                            Response.Redirect("LotDataScanningDeleteRecordByPass.aspx?DNNo=" + txtDNNo.Text.Trim().ToUpper() + "&RFIDTag=" + txtRFID.Text.Trim().ToUpper());
                        }   
                    }
                }
            }
                   ...
                   // string strLotQRData = "|"+txtLotQR.Text+"|Z";
                    if (strLotQRData.Contains("|Z1") && strLotQRData.Contains("|Z7") && strLotQRData.Contains("|Z2") && strLotQRData.Contains("|Z3") && strLotQRData.Contains("|Z4") && strLotQRData.Contains("|Z5"))
                    {
                        ...
                        else
                        {
                            ...
                            //CHECK IF PARTCODE HAVE DN QTY
                            DataSet ds = new DataSet();
                            ds = LotDataScanningDAL.CHECK_DN_AND_QR_DATA(txtDNNo.Text.Trim().ToUpper(), strPartCode, supplierid, strLoginType);
                            ...
                            {
                                lblPartCode.Text = getBetween(strLotQRData, "|Z1", "|Z");
                                mp1.Show();
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            lblMessage.Text = "PARTCODE IS INVALID!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        ...
                        {
                            lblMessage.Text = "PARTCODE MUST BE ALPHA NUMERIC CHAR ONLY!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        else if (!(getBetween(strLotQRData, "|Z2", "|Z").Length == 15))
                        {
                            lblMessage.Text = "LOT NO. IS INVALID!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        ...
                        {
                            lblMessage.Text = "LOT NO MUST BE ALPHA NUMERIC CHAR ONLY!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        else if (!(getBetween(strLotQRData, "|Z5", "|Z").Length == 21))
                        {
                            lblMessage.Text = "REF NO. IS INVALID!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        ...
                        {
                            lblMessage.Text = "REF NO. MUST BE ALPHA NUMERIC CHAR ONLY!!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        ...
                        {
                            lblMessage.Text = "QTY MUST BE NUMERIC CHAR ONLY!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        }
                        ...
                        else if (!(isValidText(@"[A-Za-z0-9#%+\(\)/\-_;,.\\]", getBetween(strLotQRData, "|Z4", "|Z"))))
                        {
                            lblMessage.Text = "INVALID REMARKS!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        ...
                        else
                        {
                            ...
                            ds5 = LotDataScanningDAL.CHECK_MAX_DN_QTY_FROM_SCANNED_TBL(txtDNNo.Text.Trim().ToUpper(), txtPartCode.Text.Trim().ToUpper(), supplierid, strLoginType);
                            //GET TOTAL SCANNED QTY OF PARTCODE
                            if (ds5.Tables[0].Rows.Count > 0)
                            {
                                string substring;
                                string total = ds5.Tables[0].Rows[0]["DNQTY"].ToString();
                                substring = total.Split('.')[0];
                                txtQty2.Text = substring;

                                //substring = ds5.Tables[0].Rows[0]["DNQTY"].ToString();
                                //txtQty2.Text = substring;
                            }
                            ...
                            {
                                string substring;
                                string scannedtotal = ds7.Tables[0].Rows[0]["TOTAL"].ToString();
                                substring = scannedtotal.Split('.')[0];
                                txtQty1.Text = substring;
                            ...
                            iQtyTotal = Convert.ToInt32(txtQty2.Text);
                            iScanned = Convert.ToInt32(txtQtyTotal.Text) + Convert.ToInt32(txtQty1.Text);
                ...
                {
                    //strLotQRData = "|" + txtLotQR.Text.Trim().ToUpper() + "|Z";
                    ...
                    else
                    {
                        ...
                        else if (!(getBetween(strLotQRData, "|Z4", "|Z").Length <= 15))
                        {
                            lblMessage.Text = "INVALID REMARKS!";
                            lblMessage.ForeColor = System.Drawing.Color.Red;
                            return;
                        ...
                        else
                        {
                            ...
                            //DataSet ds5 = new DataSet();
                            //ds5 = LotDataScanningDAL.GET_TOTALDNQTY(txtDNNo.Text, txtPartCode.Text);
                            ////GET TOTAL SCANNED QTY OF PARTCODE
                            //if (ds5.Tables[0].Rows.Count > 0)
                            //{
                            ...
                            txtQty2.Text = txtPartCodeQTY.Text;
                            ...
                            {
                                string substring;
                                string total = ds7.Tables[0].Rows[0]["TOTAL"].ToString();
                                substring = total.Split('.')[0];
                                txtQty1.Text = substring;
                            ...
                            else
                            {
                                if (strLoginType == "EPPI")
                                {
                                    ...
                                    string strResult = "";
                                    strResult = LotDataScanningDAL.ADD_SCANNED_DNDATA_EPPI(txtDNNo.Text.Trim().ToUpper(), txtRFID.Text.Trim().ToUpper(), strLotQRData, txtPartCode.Text.Trim().ToUpper(), txtLotNo.Text.Trim().ToUpper(),
                                         txtRefNo.Text.Trim().ToUpper(), Convert.ToInt32(txtQtyTotal.Text), strRemarksDecoded, Convert.ToInt32(txtQty2.Text), supplierid,
                                         0, bypassflag, scannedby, createdby);
                            ...
                            {
                                string substring;
                                string totalscanned = ds6.Tables[0].Rows[0]["TOTAL"].ToString();
                                substring = totalscanned.Split('.')[0];
                                txtQty1.Text = substring;
                        ...
                        if (procflag == "0")
                        {
                            ...
                            if (dndata == txtDNNo.Text.Trim().ToUpper())
                            {
                                ...
                                if (ds2.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    {
                                        string substring;
                                        string totalscanned = ds3.Tables[0].Rows[0]["TOTAL"].ToString();
                                        substring = totalscanned.Split('.')[0];
                                        txtQty1.Text = substring;
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            try
            {
                if (Request.QueryString["DeviceType"] != null)
                {
                    if (Request.QueryString["DeviceType"].ToString() == "Denso")
                    {
                        Response.Redirect("LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&DeviceType=Denso");
                    }
                    else if (Request.QueryString["DeviceType"].ToString() == "HT")
                    {
                        Response.Redirect("LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&DeviceType=HT");
                    }
                }
                else
                {
                    Response.Redirect("LotDataScanningByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()));
                } 
            }
            catch (Exception ex)
            {
        ...
        protected void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                //if (!re.IsMatch(txtPartCodeQTY.Text))
                if (!(isValidText(@"[0-9]", txtPartCodeQTY.Text.Trim().ToUpper())))
                {
                    MsgBox1.alert("PLS INPUT NUMERIC CHAR ONLY!");
                    txtLotQR.Text = "";
                    txtPartCodeQTY.Text = "";
                    txtLotQR.Focus();
                }
