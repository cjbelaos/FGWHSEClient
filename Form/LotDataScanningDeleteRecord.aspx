<%@ Page Language="C#" MasterPageFile="~/Form/HTMasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="LotDataScanningDeleteRecord.aspx.cs" Inherits="FGWHSEClient.Form.WebForm4" Title="LOT DATA SCANNING - DELETE RECORD" %>
...
<div id = "dvLotDataScan" runat="server" class="divInput3">
    ...
    <asp:Panel ID="Panel1" runat="server" DefaultButton="btnDelete">
            ...
            <td id="tdMessage" runat="server"  style="border: 1px solid #385d8a; background-color:#d9d9d9;text-align:left height:25px;">
                ...
                <tr>
                    <td colspan=4 align=center>
                        ...
                        <asp:Button ID="btnClear" runat="server" Text="F8 CLEAR" Height="35px" 
                            Width="70px" CssClass="buttonStyle" TabIndex="2"/>
                    </td>
                </tr>
                <tr>
                    <td height="5px"></td>
