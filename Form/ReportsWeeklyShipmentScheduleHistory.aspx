<%@ Page Language="C#" MasterPageFile="~/Form/MasterPalletMonitoring.Master"  AutoEventWireup="true" CodeBehind="ReportsWeeklyShipmentScheduleHistory.aspx.cs" Inherits="FGWHSEClient.Form.ReportsWeeklyShipmentScheduleHistory" %>
...
<%--    <span></span>--%>
    ...
    <table style="margin-left:15px; font-size:small; color:Black">
        <tr>
            <td>Invoice No.</td>
            <td><asp:TextBox ID="txtInvoiceNo" runat="server"></asp:TextBox></td><td style ="display:none"><asp:Label ID="lblUserID" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
            <td>OD No.</td>
        ...
        <tr>
            <td>Shipment No.</td>
            <td><asp:TextBox ID="txtShipmentNo" runat="server"></asp:TextBox></td>
