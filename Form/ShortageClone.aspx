<%@ Page Title="" Language="C#" MasterPageFile="~/Form/MasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="ShortageClone.aspx.cs" Inherits="FGWHSEClient.Form.ShortageClone" %>
...
<%--        <button type="button" class="btn btn-primary btn-sm" id="btnExport" style="display:none"><i class="fa-solid fa-file-export"></i> Export</button>
    ...
    <script type="text/javascript" src="../Scripts/ShortageClone.js"></script>
</asp:Content>
