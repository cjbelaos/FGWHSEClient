...
{
    public partial class IncomingInspectionInquiry_bak : System.Web.UI.Page
    {
        ...
        protected void gvIncoming_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else if (drv["PARTCODE_COLOR"].ToString() == "MAGENTA")
                {
                    //e.Row.ForeColor = System.Drawing.Color.Red;
                    e.Row.Cells[1].ForeColor = System.Drawing.Color.Magenta;
