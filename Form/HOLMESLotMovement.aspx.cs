...
{
    public partial class HOLMESLotMovement : System.Web.UI.Page
    {
        ...
        public DataTable getdetails()
        {
            ...
            DataSet ds = IHR.GET_HOLMES_LOT_MOVEMENT(txtDateFrom.Text.Trim(), txtDateTo.Text.Trim(), txtRFIDTag.Text.Trim(), txtRefNo.Text.Trim(), txtLotNo.Text.Trim(), txtPartCode.Text.Trim(), ddlArea.SelectedValue.ToString());
        ...
        {
            Response.Redirect("HOLMESLotMovement.aspx");
        ...
        public void ExportToExcel()
        {
            ...
            //    string filename = "HOLMES_LOT_MOVEMENT_" + DateTime.Now.ToString("ddMMyyyyhhmmssffffff");
            ...
            Response.AddHeader("content-disposition", "attachment;filename=HOLMES_LotMovement" + DateTime.Now.ToString("MMddyyyyHHmmssff") + ".xls");
            Response.Charset = "";
