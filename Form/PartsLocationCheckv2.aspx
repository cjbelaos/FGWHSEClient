<%@ Page Language="C#" MasterPageFile="~/Form/HTMasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="PartsLocationCheckv2.aspx.cs" Inherits="FGWHSEClient.Form.PartsLocationCheckv2" %>
...
<script type="text/javascript">
 window.history.forward(1);
    ...
    <center><asp:Label ID="lblHeader" runat="server" style="font-size:20px">PARTS LOCATION CHECK (PS1)</asp:Label>
