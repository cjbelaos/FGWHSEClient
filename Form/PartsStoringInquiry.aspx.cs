...
{
    public partial class PartsStoringInquiry : System.Web.UI.Page
    {
        ...
        private void SearchResult()
        {
            ...
            if (difDate <= 1)
            {
                ...
                //if ((txtRefNo.Text.Trim() != "") || (txtItemCode.Text.Trim() != "") || (txtLaneID.Text.Trim()!=""))
                //{
                    PartsLocationCheckDAL maint = new PartsLocationCheckDAL();
                    DataSet dvPLC = new DataSet();

                    dvPLC = maint.GetPartsStoringInquiry(txtRefNo.Text.Trim(), txtLaneID.Text.Trim(), txtItemCode.Text.Trim(), txtDateFrom.Text.Trim(), txtDateTo.Text.Trim());
            ...
            {
                MsgBox1.alert("SELECTED DATES ARE GREATER THAN MAXIMUM (1 DAY ONLY).");
            }
        }
        ...
        protected void lblReferenceNo_Click(object sender, EventArgs e)
        {
            string strReferenceNo = "";
            strReferenceNo = ((LinkButton)sender).Text.Trim().ToUpper();

            if (string.IsNullOrEmpty(strReferenceNo) == false)
            {
                Response.Redirect("PartsStoringInquiryChildLot.aspx?ReferenceNo=" + strReferenceNo);
            }
        }
    }
}
