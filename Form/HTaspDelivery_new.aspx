<%@ Page Language="C#" MasterPageFile="~/Form/HTMasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="HTaspDelivery_new.aspx.cs" Inherits="FGWHSEClient.Form.HTaspDelivery_new" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="lblHeader" runat="server" Font-Size="Small" ForeColor="Black">Delivery Serial Scan</asp:Label>
    <div>
        <br />
        <center>
            ...
            <table runat="server" width="348px" >
                ...
                <tr>
                    <td class="auto-style5">
                        <label style="font-size: small; font-weight: normal; color: #000000">Transfer Slip:</label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtTransferSlip" runat="server" Enabled="False" AutoPostBack="True" OnTextChanged="txtTransferSlip_TextChanged"></asp:TextBox>
                    </td>
                </tr>
                <tr>
