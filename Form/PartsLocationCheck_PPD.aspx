<%@ Page Language="C#" MasterPageFile="~/Form/HTMasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="PartsLocationCheck_PPD.aspx.cs" Inherits="FGWHSEClient.Form.PartsLocationCheck_PPD" %>
...
<script type="text/javascript">
 window.history.forward(1);
    ...
    <center><asp:Label ID="lblHeader" runat="server" style="font-size:20px">PPD PARTS LOCATION CHECK</asp:Label>
                ...
                <td>
                    <center>
                        ...
                        <td><asp:Label ID="Label3" runat="server" Font-Names="Calibri" Font-Size="11pt"  ForeColor="#2F4F4F" Text="LANE ID" ></asp:Label></td>
                         ...
                         <tr>
                        <td>
                            <div id="divlocation" style=" border:1; background-color:#ffc000 ; border-style:groove; width:430px; height:100px" runat="server" >
