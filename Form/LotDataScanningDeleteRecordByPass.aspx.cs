...
namespace FGWHSEClient.Form
{
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        void Page_PreInit(Object sender, EventArgs e)
        {
            ...
            {
                Page.Title = string.Format("MANUAL PARTS RECEIVING (DN BYPASS) - DELETE RECORD");
            }
            else
            {
                Page.Title = string.Format("PARTS LOADING (DN BYPASS) - DELETE RECORD");
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (strLoginType2 == "EPPI")
                {
                    lblHeader.Text = "MANUAL PARTS RECEIVING (DN BYPASS) - DELETE RECORD";
                }
                else
                {
                    lblHeader.Text = "PARTS LOADING (DN BYPASS) - DELETE RECORD";
                }
                ...
                if (!this.IsPostBack)
                {
                    if (Request.QueryString["DeviceType"] != null)
                    {
                        if (Request.QueryString["DeviceType"].ToString() == "Denso")
                        {
                            ...
                            //grdDNData.Attributes.Add("style", "font-size:x-small;width:230px;");
                            //grdHeight.Attributes.Add("style", "overflow:auto;height:115px;width:250px");
                            //txtUsername.Attributes.Add("style", "font-size:13px;width:167px;height:15px;");
                            //txtPassword.Attributes.Add("style", "font-size:13px;width:167px;height:15px;");
                            //tablestyle.Attributes.Add("style", "cellpadding:0;cellspacing:0");
                            //tdUser.Attributes.Add("style", "padding-left:5px");
                            //tdPass.Attributes.Add("style", "padding-left:5px");
                            //lblUserName.Attributes.Add("style", "font-size:x-small;");
                            //lblPassword.Attributes.Add("style", "font-size:x-small;");
                            //lblMessage2.Attributes.Add("style", "font-size:x-small;");
                            //lblMessage.Attributes.Add("style", "font-size:x-small;width:300px;");
                            //tdMessage.Attributes.Add("style", "border: 1px solid #385d8a; background-color:#d9d9d9;font-size:x-small;height:20px;width:165px");
                            //btnDelete.Attributes.Add("style", "font-size:x-small;width:55px;height:25px");
                            //btnBack.Attributes.Add("style", "font-size:x-small;width:55px;height:25px");
                            //btnClear.Attributes.Add("style", "font-size:x-small;width:53px;height:25px");
                            //lblHeader.Attributes.Add("style", "font-size:10px;");

                            //txtDNNo.Attributes.Add("style", "font-size:13px;width:165px;height:15px;");
                            //txtRFID.Attributes.Add("style", "font-size:13px;width:165px;height:15px;");
                            //txtPartCode.Attributes.Add("style", "font-size:13px;width:165px;height:15px;");
                            //txtLotNo.Attributes.Add("style", "font-size:13px;width:165px;height:15px;");
                            //txtRefNo.Attributes.Add("style", "font-size:13px;width:165px;height:15px;");
                            //txtQty.Attributes.Add("style", "font-size:13px;width:165px;height:15px;");
                            //txtRemarks.Attributes.Add("style", "font-size:13px;width:165px;height:15px;");
                            //lblDN.Attributes.Add("style", "font-size:x-small;");
                            //lblRFID.Attributes.Add("style", "font-size:x-small;");
                            //lblPCode.Attributes.Add("style", "font-size:x-small;");
                            //lblLot.Attributes.Add("style", "font-size:x-small;");
                            //lblRefNo.Attributes.Add("style", "font-size:x-small;");
                            //lblQty.Attributes.Add("style", "font-size:x-small;");
                            //lblRemarks.Attributes.Add("style", "font-size:x-small;");
                            //tablestyle2.Attributes.Add("style", "cellpadding:0;cellspacing:0");
                        ...
                        if (!(isValidText(@"[A-Za-z0-9]", Request.QueryString["RFIDTag"].ToString())))
                        {
                            if (Request.QueryString["DeviceType"] != null)
                            {
                                if (Request.QueryString["DeviceType"].ToString() == "Denso")
                                {
                                    ...
                                    Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&DeviceType=Denso';");
                                    Response.Write("</script>");
                                ...
                                else if (Request.QueryString["DeviceType"].ToString() == "HT")//added by tin 15AUG2019
                                {
                                    Response.Write("<script>");
                                    Response.Write("alert('INVALID RFID TAG!');");
                                    Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&DeviceType=HT';");
                                    Response.Write("</script>");
                                    //    Response.Redirect("LotDataScanning.aspx?DNNo=" + Request.QueryString["DNNo"].ToString() + "&DeviceType=Denso");
                                }
                            }
                            else
                            {
                                Response.Write("<script>");
                                Response.Write("alert('INVALID RFID TAG.!');");
                                Response.Write("window.location = '../Form/LotDataScanningByPass.aspx?RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "';");
                                Response.Write("</script>");
            ...
            try
            {
                if (Request.QueryString["DNNo"] != null && Request.QueryString["RFIDTag"] != null)
                {
                    if (Request.QueryString["DeviceType"] != null)
                    {
                        ...
                        {
                            //8-24-18
                            //Response.Redirect("LotDataScanningDetailsByPass.aspx?DNNo=" + txtDNNo.Text.Trim().ToUpper() + "&RFIDTag=" + txtRFID.Text.Trim().ToUpper() + "&DeviceType=Denso");
                            Response.Redirect("LotDataScanningDetailsByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&DeviceType=Denso");
                        }
                        else if (Request.QueryString["DeviceType"].ToString() == "HT")//added by tin 15AUG2019
                        {
                            //8-24-18
                            //Response.Redirect("LotDataScanningDetailsByPass.aspx?DNNo=" + txtDNNo.Text.Trim().ToUpper() + "&RFIDTag=" + txtRFID.Text.Trim().ToUpper() + "&DeviceType=Denso");
                            Response.Redirect("LotDataScanningDetailsByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()) + "&DeviceType=HT");
                        }
                    }
                    else
                    {
                        //8-24-18
                        //Response.Redirect("LotDataScanningDetailsByPass.aspx?DNNo=" + txtDNNo.Text.Trim().ToUpper() + "&RFIDTag=" + txtRFID.Text.Trim().ToUpper());
                        Response.Redirect("LotDataScanningDetailsByPass.aspx?DNNo=" + HttpUtility.UrlEncode(Request.QueryString["DNNo"].ToString()) + "&RFIDTag=" + HttpUtility.UrlEncode(Request.QueryString["RFIDTag"].ToString()));
                    } 
                }
                else if (Request.QueryString["DNNo"] != null && Request.QueryString["RFIDTag"] == null)
                {
