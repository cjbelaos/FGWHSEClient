<%@ Page Title="" Language="C#" MasterPageFile="~/Form/MasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="PSIPartsSimulationAssemblyParts.aspx.cs" Inherits="FGWHSEClient.Form.PSIPartsSimulationAssemblyParts" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid ms-4">
        <div class="row mb-4">
            <div class="col-md-6">
                <h3>Parts Simulation Assembly Parts</h3>
    ...
    <script type="text/javascript" src="../Scripts/PartsSimulationAssemblyParts.js"></script>
</asp:Content>
