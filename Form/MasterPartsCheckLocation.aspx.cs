...
{
    public partial class MasterPartsCheckLocation : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtPcode.Text.Trim() == "" || txtDescription.Text.Trim() == "" || txtLocation.Text.Trim() == "") //|| txtLocationST.Text.Trim() == "")
                {
                ...
                {
                    //Save
                    //iSave = maint.ADD_PARTS_LOCATION(txtPcode.Text.Trim(), txtDescription.Text.Trim(), txtLocation.Text.Trim(), txtLocationST.Text.Trim());
                    ...
                    iSave = maint.UPDATE_PARTS_LOCATION(txtPcode.Text.Trim(), txtLocation.Text.Trim(), txtLocationST.Text.Trim(), ddlIQA.SelectedValue.ToString(), EKANBAN, Convert.ToDecimal(txtCapacity.Text), updateby);
        ...
        private int Search(string partcode)
        {
            ...
            try
            {
                ...
                dv = maint.GetPartsLocationList_rev1(partcode);
                dt = dv.Table;
        ...
        private void deleteRowRecord()
        {
            try
            {
                string str = maint.DELETE_PARTS_LOCATION(HiddenField1.Value);
        ...
        public void ExportToExcel()
        {
            ...
            dvExport = maint.GetPartsLocationList_rev1(txtPartCode.Text.Trim());
