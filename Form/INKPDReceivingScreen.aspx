<%@ Page Language="C#"  MasterPageFile="~/Form/MasterPalletMonitoring.Master"  AutoEventWireup="true" CodeBehind="INKPDReceivingScreen.aspx.cs" Inherits="FGWHSEClient.Form.INKPDReceivingScreen" %>
...
<%--    <%Response.Write("Last updated: " + DateTime.Now.ToString());%>--%>
      ...
      <div style="float:right; margin-right:15px; font-size:13px; color:Black; display:none">
    ...
    <br />
    <br />
    <center><asp:Label ID="Label1" runat="server" Text="INK PRODUCTION MONITORING" 
