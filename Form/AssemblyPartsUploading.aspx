<%@ Page Title="" Language="C#" MasterPageFile="~/Form/MasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="AssemblyPartsUploading.aspx.cs" Inherits="FGWHSEClient.Form.AssemblyPartsUploading" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <button type="button" id="btnUpload" class="btn btn-primary btn-sm"><i class="fa-solid fa-upload"></i>&nbsp;Upload</button>
                    <button type="button" id="btnDLFormat" class="btn btn-primary btn-sm"><i class="fa-solid fa-download"></i>&nbsp;Download Template</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript" src="../Scripts/AssemblyPartsUploading.js"></script>
</asp:Content>
