<%@ Page Language="C#" MasterPageFile="~/Form/MasterPalletMonitoring.Master"  AutoEventWireup="true" CodeBehind="WeeklyShipmentSchedule.aspx.cs" Inherits="FGWHSEClient.Form.WeeklyShipmentSchedule" %>
...
function MakeStaticHeader(gridId, height, width, headerHeight, isFooter) {
 ...
 var DivMC = document.getElementById('<%= "ctl00_ContentPlaceHolder1_DivMainContent" %>');
...
document.getElementById('DivFooterRow').scrollLeft = Scrollablediv.scrollLeft;
    ...
    <br />
        <asp:Label ID="lblHead" runat="server" Text="Updating Of Container"></asp:Label>
...
<%--    <span></span>--%>
    ...
    <table style="margin-left:15px; font-size:small; color:Black">
        ...
        <tr>
            <td>Container No.</td>
            <td><asp:TextBox ID="txtContainerNo" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td></td>
    ...
    <br />
        <asp:Label ID="lblUploaded" runat="server" Font-Overline="False" ForeColor="#009933"></asp:Label>
    <br />
    <div id="DivRoot">
        ...
        <div id="DivMainContent" runat = "server" style="overflow:scroll; width:1150px; height:400px; font-size:small; color:black" onscroll="OnScrollDiv(this)" >
            ...
            <Columns>
                <asp:TemplateField HeaderText = "--">
                    <HeaderTemplate>
                     <asp:CheckBox ID="chkHeader" OnCheckedChanged = "chkHeader_CheckedChanged" AutoPostBack = "true" runat="server" Checked="false" />
                    </HeaderTemplate>
               ...
               <%-- <asp:CommandField ButtonType="Image" ShowEditButton="True" EditImageUrl="~/Image/updatelogo.png" />
                --%>
                ...
                <asp:TemplateField HeaderText = "--">
                    ...
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    <ItemTemplate>
                    <asp:ImageButton ID="imgEdit" ImageUrl="~/Image/updatelogo.png" OnClick ="imgEdit_Click" runat="server" />
                    <asp:ImageButton ID="imgBack" ImageUrl="~/Image/backicon.png" OnClick ="imgBack_Click" runat="server" Visible = "false"/>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText = "CTR NUMBER ARRIVAL DATE">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    <ItemTemplate>
                    <asp:Label ID="lblCTRNUMBERARRIVALDATE" runat="server" Text='<%# Eval("CTRNUMBERARRIVALDATE") %>'></asp:Label></ItemTemplate>
                </asp:TemplateField>
    ...
    <table id="tbUpload" runat="server" cellspacing ="10" style =" font-size:small;color:Black">
    <tr>
        <td>Weekly Shipment Schedule :</td>
        <td><asp:FileUpload ID="fuWeeklyShipmentSchedule" runat="server" /></td>
        <td>&nbsp;<asp:Button ID="btnUpload" runat="server" Text="Upload" onclick="btnUpload_Click" />&nbsp;</td>
        <td>&nbsp;<asp:Button ID="btnPost" runat="server" Text="Post" 
...
<table style ="margin-left:50px;margin-right:50px;">
    ...
    <tr>
        <td colspan><asp:TextBox ID="txtReason" runat="server" TextMode="MultiLine" 
                Height="67px" Width="274px"></asp:TextBox></td>
    </tr>
    <tr>
        <td><br /><asp:Button ID="btnSave" runat="server" Text="Save" onclick="btnSave_Click" />
...
<ajaxtoolkit:modalpopupextender ID="mp"   runat="server" PopupControlID="pnl" TargetControlID="lblTag" BackgroundCssClass="modalBackground"></ajaxtoolkit:modalpopupextender>
