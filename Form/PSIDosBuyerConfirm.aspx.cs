...
{
    public partial class PSIDosBuyerConfirm : System.Web.UI.Page
    {
        ...
        public static string GetDOS(){
            //return MyControl.GetDOS_buyer_confirm(SupplierCode
            return MyControl.GetDOS(SupplierCode);
        }
