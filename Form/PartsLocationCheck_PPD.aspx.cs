...
{
    public partial class PartsLocationCheck_PPD : System.Web.UI.Page
    {
        ...
        protected void txtPartCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    dvGetLocation = maint.GetPartsLoc_PPD(txtPartCode.Text.Trim());
                    ...
                    else
                    {
                        ...
                        foreach (DataRow dr in dvGetLocation.Table.Rows)
                        {
                            ...
                            {
                                LocationFinal = LocationFinal + "<br>" + dr["Location"].ToString().ToUpper().Trim();
                                LocationSTFinal = LocationSTFinal + "<br>" + dr["Location_ST"].ToString().ToUpper().Trim();
                            }
        ...
        //protected void btnPartsStoring_Click(object sender, EventArgs e)
        //{
        //    Session["PartsCodePLC"] = lblPartCode.Text.Trim();
        //    Session["EKANBANFLAG"] = lblEKANBANFLAG.Text.Trim();
        //    Response.Redirect("PartsLocationCheckStoring.aspx");
