<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Form/MasterPalletMonitoring.Master" CodeBehind="PSI_SHORTAGELIST_BY_PLANT.aspx.cs" Inherits="FGWHSEClient.Form.PSI_SHORTAGELIST_BY_PLANT" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="divUpload" class="col-md-4">
                <div class="form-group">
    ...
    <script type="text/javascript" src="../Scripts/ShortageListByPlant.js"></script>
</asp:Content>
