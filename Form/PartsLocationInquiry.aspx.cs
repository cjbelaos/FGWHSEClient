...
{
    public partial class PartsLocationInquiry : System.Web.UI.Page
    {
        ...
        private void SearchResult()
        {
            ...
            if ((txtRefNo.Text.Trim() != "") || (txtItemCode.Text.Trim() != "") || (txtLaneID.Text.Trim() != ""))
            {
                ...
                dvPLC = maint.GetPartsLocationInquiry(txtRefNo.Text.Trim(), txtLaneID.Text.Trim().ToUpper(), txtItemCode.Text.Trim());
