<%@ Page  Title="" Language="C#" MasterPageFile="~/Form/MasterPalletMonitoring.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="MasterPartsCheckLocation.aspx.cs" Inherits="FGWHSEClient.Form.MasterPartsCheckLocation" %>
 ...
 <div class="divLocMaster">
        <table style ="text-align:left">
                ...
                <tr>
                    ...
                    onclick="btnAdd_Click" Visible=false/> &nbsp;&nbsp
                    </td>
                    <td>
    ...
    <div id ="grid"  runat = "server"  style="width:1200px; overflow:auto; height:555px">
     <div align="center">
        ...
        <Columns>
           ...
           <asp:CommandField ShowEditButton="true" ShowDeleteButton="False" HeaderText="" ItemStyle-Width="50px" ItemStyle-Wrap="False"
            ...
            <asp:BoundField DataField="location" HeaderStyle-HorizontalAlign="Center" 
                ...
                <ItemStyle Wrap="False"></ItemStyle>
                 ...
                 <asp:BoundField DataField="location_ST" HeaderStyle-HorizontalAlign="Center" 
                HeaderStyle-Width="150pt" HeaderText="STOCKTAKING LOCATION" ItemStyle-Wrap="False" >
                <HeaderStyle HorizontalAlign="Center" Width="100pt" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPcode" runat="server" MaxLength="20" Width="180px" 
                                BackColor="LightYellow" ontextchanged="txtPcode_TextChanged"></asp:TextBox>
