<%@ Page Language="C#" MasterPageFile="~/Form/MasterPalletMonitoring.Master" AutoEventWireup="true" CodeBehind="RFIDLotMatchInquiry.aspx.cs" Inherits="FGWHSEClient.Form.RFIDLotMatchInquiry" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style =" left:40px;top:110px;">

  <br />
   &nbsp; &nbsp; <font style="font-size:17px; color:Black; font-weight:bold"> RFID-Lot Pairing Inquiry </font>
   <br />
       ...
       <%-- <tr>
        ...
        <asp:TextBox ID="txtDateTo" Width="150px" runat="server"></asp:TextBox> &nbsp;
         ...
         <tr>
            ...
            <td>
                <asp:TextBox ID="txtRFID" runat="server" Width="200px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
   ...
   <asp:Panel ID="pnlDN" runat="server">
    ...
    <asp:GridView ID="gvPLC" runat="server" Width="1160px" 
            AutoGenerateColumns="False"  CellPadding="3" BackColor="White"  
             GridLines="Both" AllowPaging="true" PageSize="50" 
             ...
             <Columns>
                 ...
                 <asp:BoundField DataField="LOTNO" ItemStyle-BorderColor="Black" HeaderText="LOT NO" 
                  HeaderStyle-BackColor="#538dd5" HeaderStyle-Font-Size="10px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="White" ItemStyle-Width="120px"
                   ItemStyle-Font-Size="11px" ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="Black"  >
                 </asp:BoundField>
                 ...
                 <asp:BoundField DataField="UPDATEFIELD" ItemStyle-BorderColor="Black" HeaderText="UPDATE FIELD" 
                  HeaderStyle-BackColor="#538dd5" HeaderStyle-Font-Size="10px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="White" ItemStyle-Width="120px"
                   ItemStyle-Font-Size="11px" ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="Black"  >
                 </asp:BoundField>
                 <asp:BoundField DataField="OLDDATA" ItemStyle-BorderColor="Black" HeaderText="OLD DATA" 
                 ...
                 <asp:BoundField DataField="NEWDATA" ItemStyle-BorderColor="Black" HeaderText="NEW DATA" 
                  HeaderStyle-BackColor="#538dd5" HeaderStyle-Font-Size="10px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="White" ItemStyle-Width="150px"
                   ItemStyle-Font-Size="11px" ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="Black"  >
                 </asp:BoundField>
                 ...
                 <asp:BoundField DataField="UPDATEDDATE" ItemStyle-BorderColor="Black" HeaderText="UPDATED DATE" 
                  HeaderStyle-BackColor="#538dd5" HeaderStyle-Font-Size="10px" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="White" ItemStyle-Width="230px"
                   ItemStyle-Font-Size="11px" ItemStyle-HorizontalAlign="Left" ItemStyle-ForeColor="Black"  >
                 </asp:BoundField>
             </Columns>
