...
{
    public partial class PartsLocationCheckPS2 : System.Web.UI.Page
    {
        ...
        protected void btnPartsStoring_Click(object sender, EventArgs e)
        {
            ...
            Session["PartsCodePLC"] = lblPartCode.Text.Trim();
            Session["LocationID"] = lblLocation.Text.Trim();
            Response.Redirect("PartsLocationCheckStoringPS2.aspx");
