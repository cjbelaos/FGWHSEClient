...
{
    public partial class HT_PAIRING_MULTILOTPARTCODE : System.Web.UI.Page
    {
        ...
        {
            Response.Write("<script>");
            Response.Write("window.location = 'HT_PAIRING_MULTILOTPARTCODE.aspx';");
            Response.Write("</script>");
        }
        ...
        public void saveList(DataTable dt, TextBox txtRFIDlabel, string strUID, string strAreaID)
        {
            ...
            for (int x = 0; x < dv.Count; x++)
            {
                ...
                pDAL.AddLotRfidPairing(strRefNo, txtRFIDlabel.Text, strLotNo, strPartCode, strQTY, strRemarks, strUID, strAreaID);
            }
