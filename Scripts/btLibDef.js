...
(function() {
	...
	Def.BT_SCAN_OCR_CHARTYPE_ALPHABET			=	0x0002;			// Alphabet
	Def.BT_SCAN_OCR_CHARTYPE_MARK				=	0x0004;			// Mark
	Def.BT_SCAN_OCR_CHARTYPE_ALL				=	0x0007;			// All
	// Character type
	...
	Def.BT_SCAN_OCR_DFMT_EACH_MARKS_ALL			=	0x000001FF;		// ALL
	...
	Def.BT_SCAN_OCR_REPORT = function(_DataFormat,_AlertType,_FormatNumber,_SourceDataLen,_SourceData){
		...
		this.FormatNumber = _FormatNumber;		// Format registration number of recognition (-2:Date recognition, -1:Range restriction, BT_SCAN_OCR_DFMT_BANK_MIN ~ BT_SCAN_OCR_DFMT_BANK_MAX:Format registration)
