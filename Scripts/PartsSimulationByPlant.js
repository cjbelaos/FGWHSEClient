...
function CheckIfForViewing(callback) {
    $.ajax({
        type: "POST",
        url: GlobalURL + "Form/PSI_PARTS_SIMULATION_BY_PLANT.aspx/CheckIfForViewing",
        data: "{}",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        success: function (e) {
...
function Export(callback) {
    ...
    var filename = 'PartsSimulation(' + moment(currentDate).format('YYYYMMDDhhmmss') + ').xlsx';
...
function Save(isUploaded) {
    ...
    for (var i in newData) {
        var FirstColumnName = headers[10];
        ...
        if (newData[i]['PLAN/LOGICAL'] == 'SUPPLIER PLAN/DELIVERY') {
            var newRow = {
                ...
                FirstColumnName: FirstColumnName,
                Past: newData[i]['PAST'],
                DAY1: newData[i][headers['10']],
                DAY2: newData[i][headers['11']],
                DAY3: newData[i][headers['12']],
                DAY4: newData[i][headers['13']],
                DAY5: newData[i][headers['14']],
                DAY6: newData[i][headers['15']],
                DAY7: newData[i][headers['16']],
                DAY8: newData[i][headers['17']],
                DAY9: newData[i][headers['18']],
                DAY10: newData[i][headers['19']],
                DAY11: newData[i][headers['20']],
                DAY12: newData[i][headers['21']],
                DAY13: newData[i][headers['22']],
                DAY14: newData[i][headers['23']],
                DAY15: newData[i][headers['24']],
                DAY16: newData[i][headers['25']],
                DAY17: newData[i][headers['26']],
                DAY18: newData[i][headers['27']],
                DAY19: newData[i][headers['28']],
                DAY20: newData[i][headers['29']],
                DAY21: newData[i][headers['30']],
                DAY22: newData[i][headers['31']],
                DAY23: newData[i][headers['32']],
                DAY24: newData[i][headers['33']],
                DAY25: newData[i][headers['34']],
                DAY26: newData[i][headers['35']],
                DAY27: newData[i][headers['36']],
                DAY28: newData[i][headers['37']],
                DAY29: newData[i][headers['38']],
                DAY30: newData[i][headers['39']],
                DAY31: newData[i][headers['40']],
                DAY32: newData[i][headers['41']],
                DAY33: newData[i][headers['42']],
                DAY34: newData[i][headers['43']],
                DAY35: newData[i][headers['44']],
                DAY36: newData[i][headers['45']],
                DAY37: newData[i][headers['46']],
                DAY38: newData[i][headers['47']],
                DAY39: newData[i][headers['48']],
                DAY40: newData[i][headers['49']],
                DAY41: newData[i][headers['50']],
                DAY42: newData[i][headers['51']],
                DAY43: newData[i][headers['52']],
                DAY44: newData[i][headers['53']],
                DAY45: newData[i][headers['54']],
                DAY46: newData[i][headers['55']],
                DAY47: newData[i][headers['56']],
                DAY48: newData[i][headers['57']],
                DAY49: newData[i][headers['58']],
                DAY50: newData[i][headers['59']],
                DAY51: newData[i][headers['60']],
                DAY52: newData[i][headers['61']],
                DAY53: newData[i][headers['62']],
                DAY54: newData[i][headers['63']],
                DAY55: newData[i][headers['64']],
                DAY56: newData[i][headers['65']],
                DAY57: newData[i][headers['66']],
                DAY58: newData[i][headers['67']],
                DAY59: newData[i][headers['68']],
                DAY60: newData[i][headers['69']],
                DAY61: newData[i][headers['70']],
                DAY62: newData[i][headers['71']],
                DAY63: newData[i][headers['72']],
                DAY64: newData[i][headers['73']],
                DAY65: newData[i][headers['74']],
                DAY66: newData[i][headers['75']],
                DAY67: newData[i][headers['76']],
                DAY68: newData[i][headers['77']],
                DAY69: newData[i][headers['78']],
                DAY70: newData[i][headers['79']],
                DAY71: newData[i][headers['80']],
                DAY72: newData[i][headers['81']],
                DAY73: newData[i][headers['82']],
                DAY74: newData[i][headers['83']],
                DAY75: newData[i][headers['84']],
                DAY76: newData[i][headers['85']],
                DAY77: newData[i][headers['86']],
                DAY78: newData[i][headers['87']],
                DAY79: newData[i][headers['88']],
                DAY80: newData[i][headers['89']],
                DAY81: newData[i][headers['90']],
                DAY82: newData[i][headers['91']],
                DAY83: newData[i][headers['92']],
                DAY84: newData[i][headers['93']],
                DAY85: newData[i][headers['94']],
                DAY86: newData[i][headers['95']],
                DAY87: newData[i][headers['96']],
                DAY88: newData[i][headers['97']],
                DAY89: newData[i][headers['98']],
                DAY90: newData[i][headers['99']],
                DAY91: newData[i][headers['100']],
                DAY92: newData[i][headers['101']],
                DAY93: newData[i][headers['102']],
                DAY94: newData[i][headers['103']],
                DAY95: newData[i][headers['104']],
                DAY96: newData[i][headers['105']],
                DAY97: newData[i][headers['106']],
                DAY98: newData[i][headers['107']],
                DAY99: newData[i][headers['108']],
                DAY100: newData[i][headers['109']],
                DAY101: newData[i][headers['110']],
                DAY102: newData[i][headers['111']],
                DAY103: newData[i][headers['112']],
                DAY104: newData[i][headers['113']],
                DAY105: newData[i][headers['114']],
                DAY106: newData[i][headers['115']],
                DAY107: newData[i][headers['116']],
                DAY108: newData[i][headers['117']],
                DAY109: newData[i][headers['118']],
                DAY110: newData[i][headers['119']],
                DAY111: newData[i][headers['120']],
                DAY112: newData[i][headers['121']],
                DAY113: newData[i][headers['122']],
                DAY114: newData[i][headers['123']],
                DAY115: newData[i][headers['124']],
                DAY116: newData[i][headers['125']],
                DAY117: newData[i][headers['126']],
                DAY118: newData[i][headers['127']],
                DAY119: newData[i][headers['128']],
                DAY120: newData[i][headers['129']],
                DAY121: newData[i][headers['130']],
                DAY122: newData[i][headers['131']],
                DAY123: newData[i][headers['132']],
                DAY124: newData[i][headers['133']],
                DAY125: newData[i][headers['134']],
                DAY126: newData[i][headers['135']],
                DAY127: newData[i][headers['136']],
                DAY128: newData[i][headers['137']],
                DAY129: newData[i][headers['138']],
                DAY130: newData[i][headers['139']],
                DAY131: newData[i][headers['140']],
                DAY132: newData[i][headers['141']],
                DAY133: newData[i][headers['142']],
                DAY134: newData[i][headers['143']],
                DAY135: newData[i][headers['144']],
                DAY136: newData[i][headers['145']],
                DAY137: newData[i][headers['146']],
                DAY138: newData[i][headers['147']],
                DAY139: newData[i][headers['148']],
                DAY140: newData[i][headers['149']],
                DAY141: newData[i][headers['150']],
                DAY142: newData[i][headers['151']],
                DAY143: newData[i][headers['152']],
                DAY144: newData[i][headers['153']],
                DAY145: newData[i][headers['154']],
                DAY146: newData[i][headers['155']],
                DAY147: newData[i][headers['156']],
                DAY148: newData[i][headers['157']],
                DAY149: newData[i][headers['158']],
                DAY150: newData[i][headers['159']],
                DAY151: newData[i][headers['160']],
                DAY152: newData[i][headers['161']],
                DAY153: newData[i][headers['162']],
                DAY154: newData[i][headers['163']],
                DAY155: newData[i][headers['164']],
                DAY156: newData[i][headers['165']],
                DAY157: newData[i][headers['166']],
                DAY158: newData[i][headers['167']],
                DAY159: newData[i][headers['168']],
                DAY160: newData[i][headers['169']],
                DAY161: newData[i][headers['170']],
                DAY162: newData[i][headers['171']],
                DAY163: newData[i][headers['172']],
                DAY164: newData[i][headers['173']],
                DAY165: newData[i][headers['174']],
                DAY166: newData[i][headers['175']],
                DAY167: newData[i][headers['176']],
                DAY168: newData[i][headers['177']],
                DAY169: newData[i][headers['178']],
                DAY170: newData[i][headers['179']],
                DAY171: newData[i][headers['180']],
                DAY172: newData[i][headers['181']],
                DAY173: newData[i][headers['182']],
                DAY174: newData[i][headers['183']],
                DAY175: newData[i][headers['184']],
                DAY176: newData[i][headers['185']],
                DAY177: newData[i][headers['186']],
                DAY178: newData[i][headers['187']],
                DAY179: newData[i][headers['188']],
                DAY180: newData[i][headers['189']],
                DAY181: newData[i][headers['190']],
                DAY182: newData[i][headers['191']],
                DAY183: newData[i][headers['192']],
                DAY184: newData[i][headers['193']],
                DAY185: newData[i][headers['194']],
                DAY186: newData[i][headers['195']],
                DAY187: newData[i][headers['196']],
                DAY188: newData[i][headers['197']],
                DAY189: newData[i][headers['198']],
                DAY190: newData[i][headers['199']],
                DAY191: newData[i][headers['200']],
                DAY192: newData[i][headers['201']],
                DAY193: newData[i][headers['202']],
                DAY194: newData[i][headers['203']],
                DAY195: newData[i][headers['204']],
                DAY196: newData[i][headers['205']],
                DAY197: newData[i][headers['206']],
                DAY198: newData[i][headers['207']],
                User: userid
            };
    ...
    if (DataForSaving.length > 0) {
        $.ajax({
            url: GlobalURL + "Form/PSI_PARTS_SIMULATION_BY_PLANT.aspx/SaveData",
            type: "POST",
...
$(function () {
    ...
    $('#btnFilter').click(function () {
        ...
        GetPartsSimulationByPlant(plant, parts, vendor);
    });
    ...
    $('#btnUpload').click(function () {
        ...
        if ($("#fileUpload").val() !== '') {
            ...
            ReadExcelFile(function (data) {
                $('#fileUpload').val('');
                DTForExport = data;
                var columns = ['PLANT', 'MATERIALNUMBER', 'DESCRIPTION', 'SUPPLIER', 'SUPPLIERNAME', 'EPPISTCK', 'SUPPLIERSTCK', 'TOTALSTCK', 'PLAN/LOGICAL', 'PAST'];
